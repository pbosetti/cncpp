...
Implements a G-code block, which is a collection of G-code commands that are executed together. Each block can contain multiple commands, and each command can have multiple parameters.
*/
