...
Generation date: 2026-05-07 17:06:27
  ...
  void install_functions() {
    ...
    add_state(cncpp::STATE_LOAD_BLOCK, [](DATA_T &data) -> cncpp::state_t {
      ...
      case cncpp::STATE_IDLE:
        break;
      default:
        throw std::runtime_error("Invalid state transition from LOAD_BLOCK to "s + state_names[next_state]);
      }
      return next_state;
    });
    ...
    add_state(cncpp::STATE_RAPID_MOTION, [](DATA_T &data) -> cncpp::state_t {
      ...
      case cncpp::STATE_LOAD_BLOCK:
        break;
      default:
        throw std::runtime_error("Invalid state transition from RAPID_MOTION to "s + state_names[next_state]);
      }
      // SIGINT transition override
      if (stop_requested) next_state = STATE_STOP;
      return next_state;
    ...
    add_state(cncpp::STATE_INTERP_MOTION, [](DATA_T &data) -> cncpp::state_t {
      ...
      case cncpp::STATE_LOAD_BLOCK:
        break;
      default:
        throw std::runtime_error("Invalid state transition from INTERP_MOTION to "s + state_names[next_state]);
      }
      // SIGINT transition override
      if (stop_requested) next_state = STATE_STOP;
      return next_state;
    ...
    add_state(cncpp::STATE_NO_MOTION, [](DATA_T &data) -> cncpp::state_t {
      ...
      case cncpp::STATE_LOAD_BLOCK:
        break;
      default:
        throw std::runtime_error("Invalid state transition from NO_MOTION to "s + state_names[next_state]);
      }
      return next_state;
    });
    ...
    add_state(cncpp::STATE_STOP, [](DATA_T &data) -> cncpp::state_t {
      ...
      case cncpp::NO_CHANGE:
        break;
      default:
        throw std::runtime_error("Invalid state transition from STOP to "s + state_names[next_state]);
      }
      return next_state;
    });
    ...
    add_state(cncpp::STATE_GO_TO_ZERO, [](DATA_T &data) -> cncpp::state_t {
      ...
      case cncpp::STATE_IDLE:
        break;
      default:
        throw std::runtime_error("Invalid state transition from GO_TO_ZERO to "s + state_names[next_state]);
      }
      // SIGINT transition override
      if (stop_requested) next_state = STATE_STOP;
      return next_state;
